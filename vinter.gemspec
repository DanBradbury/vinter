Gem::Specification.new do |s|
  ...
  s.description = "A linter for the Vim9 script language, helping to identify issues and enforce best practices. Vim9script only - legacy VimScript is not supported."
